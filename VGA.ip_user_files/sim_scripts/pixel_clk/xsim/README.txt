...
#
# Generated by export_simulation on Fri Apr 26 15:12:53 -0500 2019
#
################################################################################
...
'-reset_run' switch to the './pixel_clk.sh' script.

./pixel_clk.sh -reset_run
...
./pixel_clk.sh -noclean_files

For more information on the script, please type './pixel_clk.sh -help'.
