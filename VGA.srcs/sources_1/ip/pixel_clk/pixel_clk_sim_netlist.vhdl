...
--               C:/Users/Jacob/School/VGA-Controller/VGA.srcs/sources_1/ip/pixel_clk/pixel_clk_sim_netlist.vhdl
-- Design      : pixel_clk
...
entity pixel_clk_pixel_clk_clk_wiz is
  ...
  attribute ORIG_REF_NAME of pixel_clk_pixel_clk_clk_wiz : entity is "pixel_clk_clk_wiz";
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_pixel_clk,
      O => clkfbout_buf_pixel_clk
    );
...
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_pixel_clk,
      CLKFBOUT => clkfbout_pixel_clk,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_100m_pixel_clk,
      CLKIN2 => '0',
      CLKINSEL => '1',
...
entity pixel_clk is
  ...
  attribute NotValidForBitStream of pixel_clk : entity is true;
end pixel_clk;

architecture STRUCTURE of pixel_clk is
begin
