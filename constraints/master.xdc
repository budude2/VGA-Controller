...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports locked]
...
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { dValid_h }]; #IO_L20N_T3_A19_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { dValid_v }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2]
...
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports hclk]
set_property -dict {PACKAGE_PIN B12 IOSTANDARD LVCMOS33} [get_ports vclk]
